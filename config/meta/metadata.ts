...
export const metadata: Metadata = {
  title: {
    default: "Aelluminate Labs",
    template: "%s | Aelluminate Labs",
  },
  keywords: keywords,
  manifest: "https://aelluminate.com/manifest.json",
  generator: "Aelluminate Labs",
  applicationName: "Aelluminate Labs",
  description:
  ...
  openGraph: {
    title: "Aelluminate Labs • Loves to empowers businesses",
    description:
      "We believe in the power of vision and dedication. Our mission is to help every business we work with to soar and turn possibilities into accomplishments.",
    url: "https://aelluminate.com",
    siteName: "Aelluminate Labs",
    images: [
      {
        url: "https://aelluminate.com/og.png",
        width: 1920,
        height: 1080,
        alt: "Aelluminate Labs Open Graph Image",
      },
    ],
    locale: "en-US",
    type: "website",
